...
HD_PWD='D:/vivado_projects/arithmetic_and_logical functions/arithmetic_and_logical functions.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log asc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source asc.tcl -notrace
