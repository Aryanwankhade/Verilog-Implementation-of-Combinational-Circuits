...
HD_PWD='D:/vivado_projects/arithmetic_and_logical functions/arithmetic_and_logical functions.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log asc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source asc.tcl
