...
REM
REM Generated by Vivado on Sun Mar 08 18:07:01 +0530 2026
...
echo "xvlog --incr --relax -prj asc_tb_vlog.prj"
call xvlog  --incr --relax -prj asc_tb_vlog.prj -log xvlog.log
